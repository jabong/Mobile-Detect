...
class Mobile_Detect
{
    ...
    protected static $mobileHeaders = array(
            'HTTP_X_USER_DEVICE_TYPE'      => array('matches' => array('mobile')), // For native mobile apps
    ...
    protected static $tabletDevices = array(
        'MobileApp'         => 'tablet', //For native mobile apps
    ...
    protected static $uaHttpHeaders = array(
        'HTTP_X_USER_DEVICE_TYPE', //for native mobile apps
